...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(665, 336);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        pushButton = new QPushButton(centralWidget);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(530, 230, 131, 51));
        ...
        menuHELIX->setObjectName(QStringLiteral("menuHELIX"));
        menuDNA_matching = new QMenu(menuBar);
        menuDNA_matching->setObjectName(QStringLiteral("menuDNA_matching"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setText(QApplication::translate("MainWindow", "Open Helix", 0));
        pushButton_2->setText(QApplication::translate("MainWindow", "Quit", 0));
        label->setText(QString());
        menuHELIX->setTitle(QApplication::translate("MainWindow", "HELIX", 0));
        menuDNA_matching->setTitle(QApplication::translate("MainWindow", "DNA matching", 0));
    } // retranslateUi
